...
const Names: string[] = ['Adán', 'Violeta', 'Kendrick', 'Kevin', 'Odin', 'Carlos', 'Daniel', 'Ian', 'Jose Eduardo', 'Teresa', 'Celine', 'Samanta', 'Hassan', 'Jose Miguel', 'Dylan', 'Armando', 'Mariel', 'Karla', 'Francisco de Jesus', 'Natalia', 'Ximena', 'Abdiel', 'Yarely', 'Milka', 'Alma', 'Francisco Roman', 'Isabel', 'Elian', 'Saul'];



function calcularEdad(fechaNacimiento: Date): { años: number; meses: number } {
